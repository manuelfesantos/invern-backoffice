export const countryData = [
  ...
  { name: "Bermuda", code: "BM", locale: "en-BM" },
  ...
  { name: "Bouvet Island", code: "BV", locale: "no-BV" },
  { name: "Brazil", code: "BR", locale: "pt-BR" },
  { name: "British Indian Ocean Territory", code: "IO", locale: "en-IO" },
  { name: "Brunei Darussalam", code: "BN", locale: "ms-BN" },
  ...
  { name: "Cape Verde", code: "CV", locale: "pt-CV" },
  { name: "Cayman Islands", code: "KY", locale: "en-KY" },
  ...
  { name: "Christmas Island", code: "CX", locale: "en-CX" },
  { name: "Cocos (Keeling) Islands", code: "CC", locale: "en-CC" },
  { name: "Colombia", code: "CO", locale: "es-CO" },
  { name: "Comoros", code: "KM", locale: "fr-KM" },
  { name: "Congo", code: "CG", locale: "fr-CG" },
  {
    name: "Congo, The Democratic Republic of the",
    code: "CD",
    locale: "fr-CD",
  },
  { name: "Cook Islands", code: "CK", locale: "en-CK" },
  { name: "Costa Rica", code: "CR", locale: "es-CR" },
  { name: "Cote D'Ivoire", code: "CI", locale: "fr-CI" },
  ...
  { name: "Falkland Islands (Malvinas)", code: "FK", locale: "en-FK" },
  { name: "Faroe Islands", code: "FO", locale: "fo-FO" },
  { name: "Fiji", code: "FJ", locale: "en-FJ" },
  { name: "Finland", code: "FI", locale: "fi-FI" },
  { name: "France", code: "FR", locale: "fr-FR" },
  { name: "French Guiana", code: "GF", locale: "fr-GF" },
  { name: "French Polynesia", code: "PF", locale: "fr-PF" },
  { name: "French Southern Territories", code: "TF", locale: "fr-TF" },
  ...
  { name: "Gibraltar", code: "GI", locale: "en-GI" },
  { name: "Greece", code: "GR", locale: "el-GR" },
  { name: "Greenland", code: "GL", locale: "kl-GL" },
  { name: "Grenada", code: "GD", locale: "en-GD" },
  { name: "Guadeloupe", code: "GP", locale: "fr-GP" },
  { name: "Guam", code: "GU", locale: "en-GU" },
  { name: "Guatemala", code: "GT", locale: "es-GT" },
  { name: "Guernsey", code: "GG", locale: "en-GG" },
  ...
  { name: "Heard Island and Mcdonald Islands", code: "HM", locale: "en-HM" },
  { name: "Holy See (Vatican City State)", code: "VA", locale: "it-VA" },
  { name: "Honduras", code: "HN", locale: "es-HN" },
  { name: "Hong Kong", code: "HK", locale: "zh-HK" },
  ...
  { name: "Iran, Islamic Republic Of", code: "IR", locale: "fa-IR" },
  { name: "Iraq", code: "IQ", locale: "ar-IQ" },
  { name: "Ireland", code: "IE", locale: "en-IE" },
  { name: "Isle of Man", code: "IM", locale: "en-IM" },
  ...
  { name: "Korea, Republic of", code: "KR", locale: "ko-KR" },
  { name: "Kuwait", code: "KW", locale: "ar-KW" },
  { name: "Kyrgyzstan", code: "KG", locale: "ky-KG" },
  { name: "Lao People'S Democratic Republic", code: "LA", locale: "lo-LA" },
  ...
  { name: "Martinique", code: "MQ", locale: "fr-MQ" },
  { name: "Mauritania", code: "MR", locale: "ar-MR" },
  { name: "Mauritius", code: "MU", locale: "en-MU" },
  { name: "Mayotte", code: "YT", locale: "fr-YT" },
  { name: "Mexico", code: "MX", locale: "es-MX" },
  { name: "Micronesia, Federated States of", code: "FM", locale: "en-FM" },
  { name: "Moldova, Republic of", code: "MD", locale: "ro-MD" },
  { name: "Monaco", code: "MC", locale: "fr-MC" },
  { name: "Mongolia", code: "MN", locale: "mn-MN" },
  { name: "Montserrat", code: "MS", locale: "en-MS" },
  { name: "Morocco", code: "MA", locale: "ar-MA" },
  { name: "Mozambique", code: "MZ", locale: "pt-MZ" },
  { name: "Myanmar", code: "MM", locale: "my-MM" },
  ...
  { name: "Netherlands Antilles", code: "AN", locale: "nl-AN" },
  { name: "New Caledonia", code: "NC", locale: "fr-NC" },
  ...
  { name: "Niue", code: "NU", locale: "en-NU" },
  { name: "Norfolk Island", code: "NF", locale: "en-NF" },
  { name: "Northern Mariana Islands", code: "MP", locale: "en-MP" },
  ...
  { name: "Palestinian Territory, Occupied", code: "PS", locale: "ar-PS" },
  ...
  { name: "Philippines", code: "PH", locale: "en-PH" },
  { name: "Pitcairn", code: "PN", locale: "en-PN" },
  { name: "Poland", code: "PL", locale: "pl-PL" },
  { name: "Portugal", code: "PT", locale: "pt-PT" },
  { name: "Puerto Rico", code: "PR", locale: "es-PR" },
  { name: "Qatar", code: "QA", locale: "ar-QA" },
  { name: "Reunion", code: "RE", locale: "fr-RE" },
  { name: "Romania", code: "RO", locale: "ro-RO" },
  { name: "Russian Federation", code: "RU", locale: "ru-RU" },
  { name: "RWANDA", code: "RW", locale: "rw-RW" },
  { name: "Saint Helena", code: "SH", locale: "en-SH" },
  { name: "Saint Kitts and Nevis", code: "KN", locale: "en-KN" },
  { name: "Saint Lucia", code: "LC", locale: "en-LC" },
  { name: "Saint Pierre and Miquelon", code: "PM", locale: "fr-PM" },
  ...
  { name: "Serbia and Montenegro", code: "CS", locale: "sr-CS" },
  ...
  { name: "Svalbard and Jan Mayen", code: "SJ", locale: "no-SJ" },
  { name: "Swaziland", code: "SZ", locale: "en-SZ" },
  { name: "Sweden", code: "SE", locale: "sv-SE" },
  { name: "Switzerland", code: "CH", locale: "de-CH" },
  { name: "Syrian Arab Republic", code: "SY", locale: "ar-SY" },
  { name: "Taiwan, Province of China", code: "TW", locale: "zh-TW" },
  { name: "Tajikistan", code: "TJ", locale: "tg-TJ" },
  { name: "Tanzania, United Republic of", code: "TZ", locale: "sw-TZ" },
  { name: "Thailand", code: "TH", locale: "th-TH" },
  { name: "Timor-Leste", code: "TL", locale: "tet-TL" },
  { name: "Togo", code: "TG", locale: "fr-TG" },
  { name: "Tokelau", code: "TK", locale: "en-TK" },
  ...
  { name: "Turks and Caicos Islands", code: "TC", locale: "en-TC" },
  ...
  { name: "United States Minor Outlying Islands", code: "UM", locale: "en-UM" },
  ...
  { name: "Viet Nam", code: "VN", locale: "vi-VN" },
  { name: "Virgin Islands, British", code: "VG", locale: "en-VG" },
  { name: "Virgin Islands, U.S.", code: "VI", locale: "en-VI" },
  { name: "Wallis and Futuna", code: "WF", locale: "fr-WF" },
  { name: "Western Sahara", code: "EH", locale: "ar-EH" },
